...
/**
 * South Africa Law MCP Server — stdio entry point.
 *
 * Provides South African legislation search via Model Context Protocol.
 */
...
const DB_ENV_VAR = 'SOUTHAFRICA_LAW_DB_PATH';
