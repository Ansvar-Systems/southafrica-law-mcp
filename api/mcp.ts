...
const SERVER_NAME = 'southafrica-law-mcp';
...
const GITHUB_REPO = 'Ansvar-Systems/southafrica-law-mcp';
...
async function initializeDatabase(): Promise<void> {
  ...
  const envDb = process.env.SOUTHAFRICA_LAW_DB_PATH;
  ...
  const downloadUrl = process.env.SOUTHAFRICA_LAW_DB_URL ?? DEFAULT_RELEASE_URL;
