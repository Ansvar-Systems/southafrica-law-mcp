...
## [1.0.0] - 2026-XX-XX
### Added
- Initial release of South Africa Law MCP
- `search_legislation` tool for full-text search across all South African statutes
...
- Drift detection with 7 stable provision anchors
- Health and version endpoints
- Vercel deployment (dual tier bundled free)
- npm package with stdio transport
- MCP Registry publishing

[Unreleased]: https://github.com/Ansvar-Systems/southafrica-law-mcp/compare/v1.0.0...HEAD
[1.0.0]: https://github.com/Ansvar-Systems/southafrica-law-mcp/releases/tag/v1.0.0
